...
export default function CatererProfile() {
  ...
  useEffect(() => {
    if (profile) {
      ...
      // Service types
      setOffersBuffet(Boolean(profile.offers_buffet));
      setBuffetPrice(profile.buffet_price_per_plate != null ? String(profile.buffet_price_per_plate) : "");
      setOffersPackedDelivery(Boolean(profile.offers_packed_delivery));
      setPackedDeliveryPrice(profile.packed_delivery_price_per_box != null ? String(profile.packed_delivery_price_per_box) : "");
          ...
          <div className="rounded-xl border border-sky-500/30 bg-sky-50/40 dark:bg-sky-950/20 p-4 space-y-4">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">Select what type of service you offer and set your per-plate/box pricing.</p>
              </div>
            </div>
